...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "RECV_DEPTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.RECV_DEPTH { PARAM_VALUE.RECV_DEPTH } {
	# Procedure called to update RECV_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RECV_DEPTH { PARAM_VALUE.RECV_DEPTH } {
	# Procedure called to validate RECV_DEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.RECV_DEPTH { MODELPARAM_VALUE.RECV_DEPTH PARAM_VALUE.RECV_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RECV_DEPTH}] ${MODELPARAM_VALUE.RECV_DEPTH}
}
